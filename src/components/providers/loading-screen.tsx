    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          >
            <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-violet text-2xl font-bold text-primary-foreground shadow-[0_0_60px_-10px_var(--violet)]">
              C
            </span>
